                    ...
                    <div class="row">
                    	<div class="col-md-9 col-sm-12">
                         ...
                         <div class="col-md-3 col-sm-12">
                             <div class="card-box">
                                 <div class="card-head">
                                     <header>RFID check-in</header>
                                 </div>
                                 <div class="card-body ">
                                 	<div id="external-events">
                                        <form class="inline-form">
                                            <input type="text" value="" class="form-control" placeholder="" id="event_title" />
                                            <br/>
                                            <a href="javascript:;" id="event_add" class="btn deepPink-bgcolor"> Add RFID </a>
                                        </form>
                                        <hr/>
<!--                                        <div id="event_box" class="mg-bottom-10">-->
<!--                                            <div class="external-event label label-event-A/C maintainance ui-draggable ui-draggable-handle" style="position: relative;"></div>-->
<!--                                        </div>-->
