                            ...
                            <div class="card card-box">
                                ...
                                <div class="card-body ">
                                    ...
                                    <table class="table table-hover table-checkable order-column full-width" id="example4">
                                        <thead>
                                            <tr>
                                            	<th class="center"> calender view</th>
                                                <th class="center"> # </th>
                                                <th class="center"> Type </th>
                                                <th class="center"> AC/Non AC </th>
                                                <th class="center"> Meal Deal </th>
                                                <th class="center"> Capacity PAX </th>
                                        ...
                                        <tbody>
											<tr class="odd gradeX">
												<td class="user-circle-img">
                                                    <a href="calendar.php" class="btn btn-tbl-edit btn-xs">
                                                        <i class="fa fa-search"></i><img src="assets/img/user/user1.jpg" alt="">
                                                    </a>
												</td>
